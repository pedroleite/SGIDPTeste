...
public class IncluirFuncionarioPage extends BasePage {
	private Funcionario funcionario;

	@SuppressWarnings("serial")
	public IncluirFuncionarioPage(final PageParameters parameters) {
		super(parameters, "Funcionário", "Incluir funcionário");
		...
		TextField<String> textFieldDataNascimento = new TextField<String>("dataNascimento",
				new PropertyModel<String>(this, "funcionario.dataNascimento"));
