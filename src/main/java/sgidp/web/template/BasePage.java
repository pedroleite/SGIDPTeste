...
public class BasePage extends WebPage {
	...
	public BasePage(final PageParameters parameters,String modulo, String pagina) {
	...
	private WebMarkupContainer markupContainerManterParlamentar(
		...
		webMarkupContainer
				.add(new BookmarkablePageLink("manterParlamentarLink",
						CadastroParlamentarPage.class).setParameter("link", "02"));
